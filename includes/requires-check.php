...
// For elementor
function ldarkm_share_register_required_plugins() {
	...
	if (ldarkm_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Looks Dark Mode</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Looks Dark Mode</b> requires Elementor to be installed and activated.</p>';
...
function ldarkm_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Looks Dark Mode</b> does not work since you are using an older version of Elementor</p>';
